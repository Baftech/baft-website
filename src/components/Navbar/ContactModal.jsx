    ...
    <div className="fixed inset-0 flex items-center justify-center z-100 p-2 sm:p-4">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center mb-3 sm:mb-4">
          <img src="/logo.png" alt="BaFT Logo" className="w-[80px] sm:w-[100px] h-auto mx-auto" />
        ...
        <div className="w-full min-h-[320px] sm:min-h-[360px] relative overflow-hidden">
          ...
          <div className={`absolute inset-0 w-full transition-all duration-800 ease-out ${
            ...
            <div className="w-full bg-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col gap-3 sm:gap-3 mb-0">
              <div>
                <h3 className="font-semibold text-base sm:text-lg text-white mb-1 sm:mb-1">Contact Us</h3>
                <p className="text-xs sm:text-xs text-white/60 m-0 mb-2 sm:mb-2">Have any Query feel free to reach out</p>
              </div>
